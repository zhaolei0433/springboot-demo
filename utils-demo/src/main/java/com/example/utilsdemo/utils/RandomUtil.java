...
public class RandomUtil {
	 ...
	 *            随机字符串长度
	 * @param characterSet
	 *            number-->仅数字 letter-->仅字母 all-->包含数字和字母
	 * @return
	 */
	public static String generateString(int length, String characterSet) {
		if (characterSet != null && characterSet.equals("number"))
			return generateOnlyNumber(length);
		else if (characterSet != null && characterSet.equals("letter"))
